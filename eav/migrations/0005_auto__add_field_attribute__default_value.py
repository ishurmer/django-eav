...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attribute._default_value'
        db.add_column(u'eav_attribute', '_default_value',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attribute._default_value'
        db.delete_column(u'eav_attribute', '_default_value')
    ...
    models = {
        ...
        u'eav.attribute': {
            ...
            '_default_value': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'eav.value': {
            ...
            'value_dist': ('measurement.fields.DistanceField', [], {'null': 'True', 'unit_field': "'distance_unit'", 'blank': 'True'}),
