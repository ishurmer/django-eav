...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('eav_value', 'value_distance')

        # Adding field 'Value.value_dist'
        db.add_column('eav_value', 'value_dist',
    ...
    def backwards(self, orm):
        ...
        db.add_column('eav_value', 'value_distance',
                      self.gf('measurement.fields.DistanceField')(null=True, unit_field='distance_unit', blank=True),
                      keep_default=False)

        # Deleting field 'Value.value_dist'
        db.delete_column('eav_value', 'value_dist')
